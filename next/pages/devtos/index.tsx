...
const Devtos = ({ devtos, devtoCategories }: DevtosProps) => {
  ...
  return (
    <>
      <Head>
        <title>Bookmarked Dev.to Articles</title>
        <link rel="icon" href="/favicon.ico" />
        <meta charSet="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />

        <meta name="description" content="Awesome Dev.to Articles" />
        <meta
          name="keyword"
          content="html, css, javascript, yarn, npm, package, library, developer, development, resources, web development, learning, tips, trick"
        />

        <meta property="og:description" content="Awesome Dev.to Articles" />
        <meta property="og:type" content="website" />

        <meta name="twitter:title" content="Dev.to Articles" />
        <meta name="twitter:description" content="Awesome Dev.to Articles" />
      </Head>
      <Page
        data={devtoData}
